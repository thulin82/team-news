      ...
      this.searchResult.innerHTML += `
                <div class="form-check">
                    <label class="form-check-label">
                        ...
                        value="${teams.results[index].entity.name},${teams.results[index].entity.id}">
                        ${teams.results[index].entity.name} ${teams.results[index].entity.gender},
                        ${teams.results[index].entity.country.name} - ${teams.results[index].entity.id}
                    </label>
                </div>`;
    }
